...
Original file is located at
    https://colab.research.google.com/github/FacultadInformatica-LinkedData/Curso2023-2024-DataScience/blob/master/Assignment4/course_materials/notebooks/Task06.ipynb
...
email=Literal("janesmith@gmail.com")
...
g.add((Literal("Jown"), FOAF.knows, ns.JaneSmith))
# Visualize the results
for s,p,o in g:
  print(s,p,o)